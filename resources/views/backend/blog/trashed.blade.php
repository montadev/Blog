                    ...
                    <div class="alert alert-danger">
                      ...
                      <table class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <a href="{{route('blog.restore',$post->id)}}" class="btn btn-xs btn-default"><i class="fa fa-edit"></i></a>
                       
                            <a href="{{route('blog.deleteperma',$post->id)}}" class="btn btn-xs btn-danger"><i class="fa fa-edit"></i></a>   
