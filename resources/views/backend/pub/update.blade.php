              ...
              <div class="col-xs-12">
                <div class="box">
                  ...
                  {!!Form::model($pub, [
                   ...
                   'route' => ['blog.pub.updatepubb',$pub->id],
                   ...
                   {!!Form::text('date_fin', null,['class'=>'form-control','placeholder'=>'Y-m-d','id'=>'date_fin']) !!}
                    ...
                    <div class="form-group {{$errors->has('image') ? 'has-error' :''}}">
                      ...
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                          <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                            <img src="{{($pub->image) ? $pub->image : 'https://placehold.it/200x150&text=No+Image'}}"  alt="..." style="width: 200px; height: 150px;">
                          </div>
                    ...
                    {!! Form::submit('Update Pub',['class'=>'btn btn-primary']); !!}
